...
## Recent sessions
- **2026-06-10** — Brent: **repo rename → NightRaven** — `~/Developer/BankrollCalendar` → `~/Developer/NightRaven`; GitHub `brennin0820/NightRaven`; wired `gods-eye-projects.conf` + inventory §3 + unified stack §12; app overlay/handoff paths updated; Xcode target unchanged; Record Everything (`+#` only); push-latency §2.8 pending this commit.
