...
## Recent sessions
- **2026-06-10** — Brent: **BankrollCalendar local rebrand** — all active God'sEye/OneDayMillionaire agent labels → **NightRaven** in app repo (overlay, rules, router, protocol, AGENTS, README, handoff); Xcode target unchanged; **gods-eye framework repo not renamed**; inventory §3 oversight row updated here (`+#` only); push-latency §2.8 pending if committed from this workspace.
